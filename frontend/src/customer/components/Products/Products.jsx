      ...
      <div>
                ...
                {filters.map((section) => (
                  <Disclosure key={section.id} as="div" className="border-t border-gray-200 px-4 py-4">
                    <h3 className="-mx-2 -my-2 flow-root">
                      <DisclosureButton className="group flex w-full items-center justify-between bg-white px-2 py-2 text-gray-400 hover:text-gray-500">
        ...
        <main className="mx-auto  px-4 sm:px-6 lg:px-20">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-4 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Kurta New Arrivals</h1>
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <h1 className='text-lg opacity-50 font-bold text-left mb-4'>Filters</h1>
                {filters.map((section) => (
