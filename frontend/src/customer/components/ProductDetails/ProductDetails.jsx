  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">54555 Ratings</p>
                      ...
                      {product.sizes.map((size) => (
                        <Radio
                          ...
                          className={classNames(
                            ...
                            "group relative flex items-center justify-center rounded-md border px-0.5 py-0.25 text-xs font-medium uppercase hover:bg-gray-50 focus:outline-none data-[focus]:ring-2 data-[focus]:ring-indigo-500 sm:flex-1 sm:py-1 sm:px-0.5"
                          )}
                        >
                          <span>{size.name}</span>
                          {size.inStock ? (
        ...
        {/* rating and reviews */}
        <section>
          <h1 className="flex ml-2 font-semibold text-lg pb-4">
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="items-center space-x-3 mb-4">
                  ...
                  <p className="opacity-60">567567 Ratings</p>
                </div>
                ...
                <Box>
                  {[
                    ...
                    { label: "Good", value: 60, color: "primary" },
                    ...
                    >
                      ...
                      <Grid item xs={2}>
                        <p className="text-right">{`${rating.value}%`}</p>
                      </Grid>
                    </Grid>
                  ))}
                </Box>
        ...
        <section className="pt-10">
             <h1 className="flex py-5 text-xl font-bold mb-4">
              Similar Products
             </h1>
